...
public class CustomSqlEntityProcessor extends EntityProcessorBase {
    private static final Logger LOG = LoggerFactory.getLogger(CustomSqlEntityProcessor.class);
    ...
    public Map<String, Object> nextModifiedParentRowKey() {
        if (rowIterator == null) {
            ...
            System.out.println("====================="+parentDeltaQuery+"=======================");
